...
| `RELEASE_IMAGE_LATEST` | CI release image URL | Required (for CI mode) |
| `NAMESPACE` | CI namespace for image resolution | Required (for CI mode) |
...
**Example (Direct binary execution):**
```bash
