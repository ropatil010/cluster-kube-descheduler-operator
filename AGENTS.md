...
- See [CONTRIBUTING.md - E2E Tests](./CONTRIBUTING.md#e2e-tests) for detailed environment variable descriptions
...
- Use `resourceapply` helpers from library-go when available
- Handle errors properly in sync() - return transient errors to trigger retry
